...
void CTextProgressCtrl::OnSetShowText(WPARAM bShow, LPARAM)
{
...
void CTextProgressCtrl::OnSetRange(WPARAM, LPARAM range)
{
    OnSetRange32(LOWORD(range), HIWORD(range));
}

void CTextProgressCtrl::OnSetRange32(WPARAM Lower, LPARAM Upper)
{
    m_nMax = (int)Upper;
    m_nMin = (int)Lower;
}
