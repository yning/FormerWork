...
IMPLEMENT_DYNCREATE( CWinAppSingle, CWinApp)
CWinAppSingle::CWinAppSingle( LPCTSTR lpszAppName /*NULL*/ )
		 : CWinApp( lpszAppName )
		 , m_uMsgCheckInst( NULL )
{	
}

CWinAppSingle::~CWinAppSingle( void )
{	
	m_uMsgCheckInst = NULL;	
}

BEGIN_MESSAGE_MAP(CWinAppSingle, CWinApp)	
END_MESSAGE_MAP()

// CWinAppSingle message handlers

BOOL CWinAppSingle::PreTranslateMessage( LPMSG pMsg )
{
...
// CWinAppSingle functions

BOOL CWinAppSingle::InitInstance( LPCTSTR lpszUID /*NULL*/ )
{		
	if( lpszUID != NULL )
	{
...
BOOL CWinAppSingle::FindAnotherInstance( LPCTSTR lpszUID )
{
	ASSERT( lpszUID != NULL );
...
BOOL CWinAppSingle::PostInstanceMessage( WPARAM wParam, LPARAM lParam )
{
...
BOOL CWinAppSingle::EnableTokenPrivilege( LPCTSTR lpszSystemName, 
									  BOOL    bEnable /*TRUE*/ )
{
