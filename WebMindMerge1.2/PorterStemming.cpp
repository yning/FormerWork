///////////////////////////////////////////////////////////////
// PorterStemming.cpp: implementation of the CPorterStemming class.
//
///////////////////////////////////////////////////////////////
...
int ContainsVowel(char *word)   /* in: buffer with word checked */ //vowel:ิชา๔
{
...
int EndsWithCVC(char *word)   /* in: buffer with the word checked */
{
...
CPorterStemming::CPorterStemming()
{
}
