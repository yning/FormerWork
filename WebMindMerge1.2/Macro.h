...
#define SMP_SAVE		pmf->GetMenu()->GetSubMenu(0)->GetSubMenu(6)
#define SMP_CLOSE		pmf->GetMenu()->GetSubMenu(0)->GetSubMenu(10)
...
#define SMP_AUTOFILL	pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(0)
#define SMP_DOWNLOAD	pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(1)

#define SMP_SKIN		pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(3)
#define SMP_CLEAN		pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(4)
#define SMP_EXTOOLS		pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(5)
#define SMP_FILTER		pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(7)

#define SMP_SEARCH		pmf->GetMenu()->GetSubMenu(4)->GetSubMenu(12)
...
#define IS_HTTP(str)		(str.Left(7)=="http://" || str.Left(8)=="https://")
