// WebMindNSHandle.cpp : Implementation of CWebMindApp and DLL registration.
...
CWebMindNSHandle::CWebMindNSHandle()
{
}

STDMETHODIMP CWebMindNSHandle::Start(
        LPCWSTR szUrl,
...
STDMETHODIMP CWebMindNSHandle::Continue(PROTOCOLDATA *pStateInfo)
{
	return S_OK;
}

STDMETHODIMP CWebMindNSHandle::Abort(HRESULT hrReason,DWORD dwOptions)
{
	return E_NOTIMPL;
}

STDMETHODIMP CWebMindNSHandle::Terminate(DWORD dwOptions)
{
	return  S_OK;
}

STDMETHODIMP CWebMindNSHandle::Suspend()
{
...
STDMETHODIMP CWebMindNSHandle::Resume()
{
...
STDMETHODIMP CWebMindNSHandle::Read(void *pv, ULONG cb, ULONG *pcbRead)
{
	try{
...
STDMETHODIMP CWebMindNSHandle::Seek(
...
STDMETHODIMP CWebMindNSHandle::LockRequest(DWORD dwOptions)
{
...
STDMETHODIMP CWebMindNSHandle::UnlockRequest()
{
...
STDMETHODIMP CWebMindNSHandle::CombineUrl(LPCWSTR pwzBaseUrl, LPCWSTR pwzRelativeUrl, DWORD dwCombineFlags,
...
STDMETHODIMP CWebMindNSHandle::CompareUrl(LPCWSTR pwzUrl1, LPCWSTR pwzUrl2, DWORD dwCompareFlags)
{
...
STDMETHODIMP CWebMindNSHandle::ParseUrl(LPCWSTR pwzUrl, PARSEACTION ParseAction, DWORD dwParseFlags,
	LPWSTR pwzResult, DWORD cchResult, DWORD *pcchResult, DWORD dwReserved)
{
...
STDMETHODIMP CWebMindNSHandle::QueryInfo( LPCWSTR pwzUrl, QUERYOPTION QueryOption, DWORD dwQueryFlags,
