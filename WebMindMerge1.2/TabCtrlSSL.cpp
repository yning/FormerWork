...
void CTabCtrlSSL::PreSubclassWindow() 
{
...
int CTabCtrlSSL::AddSSLPage (LPCTSTR pszTitle, int nPageID, CTabPageSSL* pTabPage, int nImage)
{
	// Add a page to the tab control.
    TabDelete tabDelete;
    tabDelete.pTabPage = pTabPage;
    tabDelete.bDelete = FALSE;
	tabDelete.nImage = nImage;

    return AddPage (pszTitle, nPageID, tabDelete);
}

int CTabCtrlSSL::AddSSLPage (LPCTSTR pszTitle, int nPageID, LPCTSTR pszTemplateName, int nImage)
{
...
int CTabCtrlSSL::AddSSLPage (LPCTSTR pszTitle, int nPageID, int nTemplateID, int nImage) {
	return AddSSLPage (pszTitle, nPageID, MAKEINTRESOURCE (nTemplateID), nImage);
}
...
void CTabCtrlSSL::SetTabColor(int itemID, COLORREF crTab)
{
	m_hColorTabID = itemID;
	crTabColor = crTab;
}
